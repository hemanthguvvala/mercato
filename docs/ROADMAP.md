...
| 4 | Saga + outbox + threading | ◧ in progress | inventory + payment + **saga orchestrator** done+verified (c931987); **transactional outbox done + verified live** incl. Kafka-down test (2026-06-23). Next: idempotency → distributed lock/concurrency |
