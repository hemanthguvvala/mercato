...
/**
 * Issues signed JWTs. This service only SIGNS tokens (issuance); validation lives in the
 * gateway and the resource services, which hold the same secret and verify HS256 locally.
 */
@Service
